...
import { generateComprehensiveQuiz } from '@/ai/flows/generate-comprehensive-quiz';
...
export default function ComprehensiveQuizPage() {
    ...
    const handleSubmit = () => {
        setSubmitted(true);
        handleUpdateStats(0, "Comprehensive");
    };
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-full min-h-[400px]">
                ...
                <p className="ml-4 text-muted-foreground">Generating your comprehensive quiz...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold font-headline">Comprehensive Tense Test</h1>
            <p className="text-muted-foreground">
                Test your knowledge across multiple tenses. The questions are generated dynamically by AI.
            </p>
